...
* optimization:
    ...
    - Adam
    - learning rate decay
* normalize inputs rather than divide 255
* gradient checking
* batch norm
...
* visualize neural networks: see activations of (l, j) neuron as image
* how do you "see" saturation? or whatever else the above methods fix.
* some helpful plots
    - training/dev/test cost/error per epoch
...
def init_params(layer_dims):
    ...
    params['b'] = [np.zeros((l, 1)) for l in layer_dims[1:]]
    return params
...
if __name__ == '__main__':
    ...
    model(X_train, Y_train, X_test, Y_test, [n_x, 30, n_y], 30, 10, 3.0)
